...
-- Permitir que usuários autenticados acessem o bucket crm
DROP POLICY IF EXISTS "Authenticated users can access crm bucket" ON storage.objects;
CREATE POLICY "Authenticated users can access crm bucket" 
